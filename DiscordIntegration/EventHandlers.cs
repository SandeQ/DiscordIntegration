...
namespace DiscordIntegration_Plugin
{
	public class EventHandlers
	{
		...
		{
			if (plugin.Banned)
				ProcessSTT.SendData($"{ev.Details.OriginalName} - {ev.Details.Id} {Plugin.translation.WasBannedBy} {ev.Details.Issuer} {Plugin.translation._For} {ev.Details.Reason}. {(ev.Details.Expires)}", HandleQueue.CommandLogChannelId);
		}
